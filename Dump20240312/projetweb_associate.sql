...
CREATE TABLE `associate` (
  ...
  KEY `eventID` (`eventID`),
  CONSTRAINT `associate_ibfk_1` FOREIGN KEY (`imageID`) REFERENCES `image` (`id`),
  CONSTRAINT `associate_ibfk_2` FOREIGN KEY (`eventID`) REFERENCES `events` (`id`)
...
-- Dump completed on 2024-03-12  1:55:06
